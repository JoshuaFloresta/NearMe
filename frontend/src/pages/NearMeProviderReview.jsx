...
export default function NearMeProviderReview() {
  ...
  if (user.role !== 'provider' || !isProviderUnderReview(user)) return <Navigate to="/" replace />;
    ...
    <div className="min-h-screen bg-bauhaus-canvas font-outfit flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <section className="w-full max-w-2xl bg-white border-4 border-bauhaus-ink shadow-bauhaus-lg p-6 sm:p-8 relative">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-bauhaus-blue text-white border-2 border-bauhaus-ink font-black text-[10px] uppercase tracking-wider">
